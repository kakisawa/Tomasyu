...
namespace {
	const char* kTimeFilePath = "Data/csv/TimeRankingData.csv";	// スコアランキングデータを保存するファイル名パス
	const char* kScoreFilePath = "Data/csv/ScoreRankingData.csv";	// タイムランキングデータを保存するファイル名パス
